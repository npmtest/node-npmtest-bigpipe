...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-bigpipe/node_modules/bigpipe.js/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-bigpipe/node_modules/bigpipe.js/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-bigpipe/node_modules/bigpipe.js/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
  ...
  use: {
    css: {
      server: <span class="fstat-no" title="function not covered" >function server(bigpipe) {</span>
<span class="cstat-no" title="statement not covered" >        var compiler = bigpipe._compiler;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        compiler.on('assembly', compiler.namespace);</span>
      }
    }
  }
}).on(module);
